...
val projectsListPre = listOf(
    ...
    PageAllItemData(
        image = R.drawable.aoogle_logo,
        heading = "Own Crafted Android App",
        url = "https://play.google.com/store/apps/details?id=com.codexdroid.aoogleapp",
        title = "Aoogle App",
        desc = "Android Portfolio in Google Search Theme, Extended Version of Android App from Website, Where App has Resume about me, app made in india with Jetpack compose.",
    ...
    PageAllItemData(
        image = R.drawable.logo_the_guru,
        heading = "Own Crafted Android App",
    ...
    PageAllItemData(
        image = R.drawable.logo_credithive,
        heading = "Organizational Android App from scratch",
        url = "https://play.google.com/store/apps/",
    ...
    PageAllItemData(
        image = R.drawable.ic_globe_asia,
        heading = "Organizational Android App from scratch",
        url = "https://play.google.com/store/apps/",
...
val projectsListPost = listOf(
    ...
    PageAllItemData(
        image = R.drawable.logo_sky_recharge,
        heading = "Organizational Android App from scratch",
    ...
    PageAllItemData(
        image = R.drawable.logo_grampanchayat,
        heading = "Organizational Android App from scratch",
        url = "https://play.google.com/store/apps/",
        title = "Grampanchayat",
    ...
    PageAllItemData(
        image = R.drawable.logo_glasswing,
    ...
    PageAllItemData(
        image = R.drawable.logo_kichenbaba,
